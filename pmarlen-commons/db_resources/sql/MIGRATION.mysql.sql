...
ALTER TABLE ENTRADA_SALIDA  ADD COLUMN DESCUENTO_APLIC  DOUBLE   NULL;
...
INSERT INTO SUCURSAL( ID,ID_PADRE,CLAVE,NOMBRE                                               ,DIRECCION          ,TELEFONOS   ,USUARIO_SICOFI,PASSWORD_SICOFI,SERIE_SICOFI,COMENTARIOS,DESCUENTO_MAYOREO_HABILITADO)
              VALUES(  6,       1,'PMS5','PERFUMERIA MARLEN S.A. DE C.V. SUCURSAL X'         ,'CALLE XXX  MUNICIPIO DE TECÁMAC, ESTADO DE MÉXICO, C.P. 55755'                                                           ,'55-5936-2597','SINUSUARIO'  ,'SINPASSWORD'  ,'XXX'  ,NULL       ,NULL);
INSERT INTO SUCURSAL( ID,ID_PADRE,CLAVE,NOMBRE                                               ,DIRECCION          ,TELEFONOS   ,USUARIO_SICOFI,PASSWORD_SICOFI,SERIE_SICOFI,COMENTARIOS,DESCUENTO_MAYOREO_HABILITADO)
              VALUES(  7,    NULL,'PMCD','PERFUMERIA MARLEN S.A. DE C.V. CENTRO DE DISTRIBUCIÓN TECAMAC'     ,'CALLE CENTENARIO DE LA EDUCACION MZ. 24, LT. 10, COL. CENTRO, MPO. TECAMAC, EDO. DE MEX. C.P. 55740'    ,'55-5936-2597','SINUSUARIO'  ,'SINPASSWORD'  ,'XXX'  ,NULL       ,NULL);
