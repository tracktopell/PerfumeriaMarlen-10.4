...
public class ZipSyncDTOPackageClient {
	...
	private static String urlService = "http://localhost:8070/l30/rest/syncservice/json/syncdtopackage/zip";
	
	private static String uriService =                      "/l30/rest/syncservice/json/syncdtopackage/zip";
	...
	private static SyncDTOPackage getAllOfSucursal(String hostPort){
		...
		try {
			...
			syncDTORequest.setSucursalId("1");
