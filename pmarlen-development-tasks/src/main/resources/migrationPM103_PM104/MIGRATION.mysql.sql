INSERT INTO SUCURSAL( ID,ID_PADRE,NOMBRE                                               ,DIRECCION          ,TELEFONOS   ,USUARIO_SICOFI,PASSWORD_SICOFI,SERIE_SICOFI,COMENTARIOS,DESCUENTO_MAYOREO_HABILITADO)
              VALUES(  3,       1,'PERFUMERIA MARLEN S.A. DE C.V. SUCURSAL TECÁMAC'    ,'TECÁMAC CENTRO'   ,'5500000000','SINUSUARIO'  ,'SINPASSWORD'  ,'SINSERIE'  ,NULL       ,NULL                        );
INSERT INTO SUCURSAL( ID,ID_PADRE,NOMBRE                                               ,DIRECCION          ,TELEFONOS   ,USUARIO_SICOFI,PASSWORD_SICOFI,SERIE_SICOFI,COMENTARIOS,DESCUENTO_MAYOREO_HABILITADO)
              VALUES(  4,       1,'PERFUMERIA MARLEN S.A. DE C.V. SUCURSAL OJO DE AGUA','OJO DE AGUA'      ,'5500000000','SINUSUARIO'  ,'SINPASSWORD'  ,'SINSERIE'  ,NULL       ,NULL                        );
INSERT INTO SUCURSAL( ID,ID_PADRE,NOMBRE                                               ,DIRECCION          ,TELEFONOS   ,USUARIO_SICOFI,PASSWORD_SICOFI,SERIE_SICOFI,COMENTARIOS,DESCUENTO_MAYOREO_HABILITADO)
              VALUES(  5,       1,'PERFUMERIA MARLEN S.A. DE C.V. ALMACÉN TECÁMAC'     ,'TECÁMAC NUEVA'    ,'5500000000','SINUSUARIO'  ,'SINPASSWORD'  ,'SINSERIE'  ,NULL       ,NULL                        );
