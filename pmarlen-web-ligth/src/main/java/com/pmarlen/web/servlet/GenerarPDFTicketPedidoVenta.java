...
public class GenerarPDFTicketPedidoVenta extends HttpServlet {
	private final Logger logger = Logger.getLogger(GenerarPDFTicketPedidoVenta.class.getSimpleName());
	/**
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			logger.trace("GenerarPDFPedidoVenta servlet: pedidoIdIndex="+pedidoIdIndex+", pdfIndex="+pdfIndex);
