...
@ManagedBean(name="fastEditarPedidoVentaMB")
@ViewScoped
public class FastEditarPedidoVentaMB implements Serializable{	
	protected static transient Logger logger = Logger.getLogger(FastEditarPedidoVentaMB.class.getName());
...
//	}
	...
	public boolean isFacturable(){
		return entradaSalida!=null && 
				...
				(entradaSalida.getEstadoId() == Constants.ESTADO_FACTURADO && entradaSalida.getCfdId()!=null && entradaSalida.getCfdCallingErrorResult()!=null));
	}
