...
@ManagedBean(name="historicoTraspasosSucMB")
@SessionScoped
public class HistoricoTraspasosSucMB  implements Serializable {
	private transient static Logger logger = Logger.getLogger(HistoricoTraspasosSucMB.class.getSimpleName());
